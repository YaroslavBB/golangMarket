...
// Source: ../internal/modules/autorization/interface.go

// Package autorization is a generated GoMock package.
package autorization

import (
	reflect "reflect"
	autorizatione "task/internal/entity/autorizatione"
...
func (m *MockRepository) LoadUserByUsername(tx *sqlx.Tx, username string) (*autorizatione.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "LoadUserByUsername", tx, username)
	ret0, _ := ret[0].(*autorizatione.User)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockRepository) SaveUser(tx *sqlx.Tx, user autorizatione.User) error {
	m.ctrl.T.Helper()
...
// LoadUserByUsername mocks base method.
func (m *MockService) LoadUserByUsername(tx *sqlx.Tx, username string) (*autorizatione.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "LoadUserByUsername", tx, username)
	ret0, _ := ret[0].(*autorizatione.User)
	ret1, _ := ret[1].(error)
...
// SaveUser mocks base method.
func (m *MockService) SaveUser(tx *sqlx.Tx, user autorizatione.User) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SaveUser", tx, user)
	ret0, _ := ret[0].(error)
	return ret0
